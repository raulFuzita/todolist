...
- [Get Started](#createAccount)
- [Log In](#loginAccount)
- [Create Tasks](#createTask)
- [Close Tasks](#closeTask)
- [Option Menu](#optionMenu)
- [Change Password And Adding a Picture](#changePassword)
- [Activate Token for API Access](#activateToken)
- [Using Token with API](#useAPI)
    - [Get Method](#getMethod)
    - [Post Method](#postMethod)
    - [Put/ Update Method](#putMethod)
...
Let's get started and create an account to enjoy the Todo list to its fullest! Creating an account is easy peasy, you are found on the home page you should see the **Sign-Up** button in the top right corner.  <br>
...
Make sure to use the same password in the field for password confirmation.<br>
...
## Logging your account {#loginAccount}
...
Don't wait, type your first task and press the **Add** button.<br>
...
## Todo List Option Manu {#optionMenu}
...
## Changing Password And Adding a Picture {#changePassword}

<br>

To change your password or add a picture you can access this option by clicking on your profile (top right corner) and selecting the settings option. If you can't find a dropdown menu look at the step above about [Option Menu](#optionMenu).<br>
...
## Activating Token / API {#activateToken}
...
If you don't know how to enable and get a token to follow this [step](#activateToken).<br>
...
If you aren't familiar with a get method you can read more about it [here](#getMethod).
...
If you aren't familiar with a get method you can read more about it [here](#getMethod).<br>
